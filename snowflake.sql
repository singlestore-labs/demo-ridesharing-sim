...
GRANT USAGE ON WAREHOUSE RIDESHARE_INGEST TO ROLE RIDESHARE_INGEST;
GRANT OPERATE ON WAREHOUSE RIDESHARE_INGEST TO ROLE RIDESHARE_INGEST;
...
-- replace this line with the output from ./kafka/keygen.sh
...
CREATE STORAGE INTEGRATION rideshare_s3_int
  ...
  STORAGE_PROVIDER = 'S3'
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::975050197855:role/mysnowflakerole'
  STORAGE_ALLOWED_LOCATIONS = ('s3://bk1031/rideshare/');

DESC INTEGRATION rideshare_s3_int;

CREATE OR REPLACE STAGE rideshare_s3_stage
  STORAGE_INTEGRATION = rideshare_s3_int
  URL = 's3://bk1031/rideshare/';
...
CREATE OR REPLACE EXTERNAL VOLUME s3_rideshare_iceberg_volume
   STORAGE_LOCATIONS = (
         (
            ...
            STORAGE_PROVIDER = 'S3'
            STORAGE_BASE_URL = 's3://bk1031/rideshare/'
            STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::975050197855:role/mysnowflakerole'
            STORAGE_AWS_EXTERNAL_ID = 'TPB44528_SFCRole=10815_/r1gTHORb7WLPe5EIP4XPPVl8Ug='
         )
    );
